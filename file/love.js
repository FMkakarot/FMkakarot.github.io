(function(window){
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || this.getRandomHeartColor(); // Random green color
    ...
    Bloom.prototype = {
        ...
        getRandomHeartColor: function() {
            // Randomly choose between the six specified colors
            const colors = [
                this.getYellowColor(),
                this.getOffWhiteColor(),
                this.getLightBlueColor(),
                this.getSoftGreenColor(),
                this.getLavenderColor(),
                this.getPeachColor()
            ];
            return colors[random(0, colors.length - 1)];
        },
        getYellowColor: function() {
            return 'rgb(247, 224, 124)'; // #F7E07C
        },
        getOffWhiteColor: function() {
            return 'rgb(245, 245, 245)'; // #F5F5F5
        },
        getLightBlueColor: function() {
            return 'rgb(173, 216, 230)'; // #ADD8E6
        },
        getSoftGreenColor: function() {
            return 'rgb(185, 235, 196)'; // #B9EBC4
        },
        getLavenderColor: function() {
            return 'rgb(230, 230, 250)'; // #E6E6FA
        },
        getPeachColor: function() {
            return 'rgb(255, 218, 185)'; // #FFDAB9
        },
        flower: function() {
            var s = this;
            s.draw();
